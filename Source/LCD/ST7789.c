...
#if OPT_DIM_BACKLIGHT
uint32_t g_backlight_pct = 15; // set default BL brightness here REMOVE
#else
uint32_t g_backlight_pct = 100; // set default BL brightness here REMOVE
#endif
